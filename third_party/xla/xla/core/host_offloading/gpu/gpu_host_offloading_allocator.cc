...
StagingBuffer::~StagingBuffer() {
  ::operator delete(data_, num_bytes_, std::align_val_t{xla::cpu::Align()});
}
...
// DMA buffer allocator allocates chunks of memory pre-mapped for TPU DMA
// transfers. We rely on BFC allocator to allocate buffers requested by the user
// from the pre-mapped chunks of memory.
