...
absl::StatusOr<llvm::Function*> Intrinsic::Rsqrt::CreateDefinition(
    llvm::Module* module, Intrinsic::Type type) {
  llvm::Type* input_type = Intrinsic::TypeToIrType(type, module->getContext());
  ...
  llvm::Function* func = llvm::dyn_cast<llvm::Function>(
      module->getOrInsertFunction(Intrinsic::Rsqrt::Name(type), function_type)
          .getCallee());
