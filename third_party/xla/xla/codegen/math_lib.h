...
class MathFunction {
 public:
  ...
  virtual std::vector<std::vector<Intrinsic::Type>> SupportedVectorTypes()
      const = 0;

  // Returns true if the function is simd masked.
  ...
  virtual llvm::Function* CreateDefinition(
      llvm::Module& module, absl::string_view function_name,
      absl::Span<const Intrinsic::Type> types) const = 0;
