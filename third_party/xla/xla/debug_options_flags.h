...
// 1. Mark it as deprecated in the flag description, by prefixing it with
//    "[Deprecated]".
// 2. Move it to the kDeprecatedFlags list in `GetFlagStatus` in
//    `debug_options_flags.cc`
// 2. After 6 months, the flag can be removed or disabled.
//
