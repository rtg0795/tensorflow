...
_GPU_L4_SELF_HOSTED_BUILD = nvidia_gpu_build_with_compute_capability(
    type_=BuildType.GPU_L4_SELF_HOSTED,
    image_url=None,
    configs=("warnings", "rbe_linux_cuda_nvcc"),
...
_KOKORO_JOB_NAME_TO_BUILD_MAP = {
    ...
    "xla-linux-x86-gpu-l4": _GPU_L4_SELF_HOSTED_BUILD,
